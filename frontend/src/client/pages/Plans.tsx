                  ...
                  >
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex items-start gap-2">
                        <svg className="w-4 h-4 text-[#C8923A] shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {(plan.discountPercent ?? 0) > 0 && (
                        <div className="flex items-start gap-2">
                          ...
                          <span className="min-w-0 text-sm text-[var(--text-primary)]">
                            <strong className="text-green-500">{plan.discountPercent}% off</strong> em produtos e serviços
                          </span>
                        </div>
                      )}
                    </div>
