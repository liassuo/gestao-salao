        ...
        <div className="relative rounded-2xl border border-[#3D2B1F] bg-[#1E1610]/90 p-8 shadow-2xl backdrop-blur-sm">
          ...
          {sent ? (
            <div className="text-center">
              ...
              <Link to="/login" className="text-sm text-[#C8923A] hover:text-[#D4A85C] transition-colors">
                ← Voltar ao login
              </Link>
            </div>
          ) : (
            <>
              ...
              <div className="mt-6 text-center">
                <Link to="/login" className="inline-flex items-center gap-1.5 text-sm text-[#8B7D6B] hover:text-[#D4C4A0] transition-colors">
