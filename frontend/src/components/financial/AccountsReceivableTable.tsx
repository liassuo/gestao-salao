import { TrendingUp, CheckCircle, Trash2 } from 'lucide-react';
...
export function AccountsReceivableTable({ transactions, onMarkAsPaid, onDelete, isLoading }: AccountsReceivableTableProps) {
  if (transactions.length === 0) {
    return (
      <EmptyState
        icon={TrendingUp}
        title="Nenhuma receita encontrada"
        description="Nao ha contas a receber registradas para o periodo selecionado."
      />
    );
  }
