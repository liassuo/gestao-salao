    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-5">
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-xl border border-[var(--border-color)] bg-[var(--hover-bg)] px-3 py-2.5 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
