...
import { Bell, LogOut, User, Sun, Moon, AlertTriangle, Menu } from 'lucide-react';
      ...
      <div className="flex h-full items-center justify-between px-4 lg:px-6">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <button
            ...
            className={`relative rounded-xl p-2 sm:p-2.5 transition-colors hover:bg-[var(--hover-bg)] ${
              lowStockCount > 0
